...
def main():
    ...
    X_train_outputfile = "../dataset/2.1_X_train.csv.gz"
    X_valid_outputfile = "../dataset/2.1_X_valid.csv.gz"
    y_train_outputfile = "../dataset/2.1_y_train.csv.gz"
    y_valid_outputfile = "../dataset/2.1_y_valid.csv.gz"
